...
class SerialComm:
    ...
    def __init__(self, port='COM4', baudrate=9600, timeout=1): 
        ...
        self.format_time = time.strftime("%H:%M:%S",self.local_time)
        self.stop_time = "19:26:10" #time set for command to proceed
    ...
    def do_ping(self):
        print("running do_ping")
        print(self.format_time,self.stop_time)
        if(self.format_time == self.stop_time):
            print("pongpong")
        return b'pong'
